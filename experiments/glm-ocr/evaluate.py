#!/usr/bin/env python3
"""
evaluate.py — Score GLM-OCR HTML outputs against ground-truth source HTML.

Scoring rubric (same as docling/parsr experiments for apples-to-apples comparison):
